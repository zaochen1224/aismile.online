    ...
    async init() {
        try {
            ...
            try {
                ...
                console.warn('Mobile compatibility check warning:', error);
            }
            ...
            if (this.uploadArea && this.fileInput) {
                ...
                if (isMobile) {
                    ...
                    try {
                        ...
                        console.warn('Mobile text setting failed:', error);
                    }
                } else {
                    // 桌面端保持原有行为
                    try {
